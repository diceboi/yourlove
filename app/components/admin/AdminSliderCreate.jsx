...
import { TbChevronLeft, TbPhoto } from "react-icons/tb"
...
export default function AdminSliderCreate({ onClose }) {
    ...
    const [form, setForm] = useState({
        ...
        button_title: "",
        button_link: "",
        button_icon: "TbArrowRight",
        bg_image: "",
        bg_image_alt: "",
        bg_overlay_color: "bg-[var(--black)]",
        bg_overlay_opacity: "opacity-10",
        display_order: 0,
    })
    ...
    const handleSave = async () => {
        ...
        toast.success("Slide létrehozva!")
        handleClose()
        router.refresh()
    }
