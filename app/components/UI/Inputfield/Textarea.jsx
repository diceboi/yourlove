  ...
  return (
    <fieldset className="flex flex-col items-start rounded-md group bg-white shadow-sm">
      ...
      <textarea
        ...
        className={`w-full py-2 px-2 outline outline-white  group-focus-within:border-[var(--green)]  text-sm focus:outline-[var(--green)] active:outline-[var(--green)] bg-white rounded-b-md ${classname}`}
      />
    </fieldset>
  );
}
