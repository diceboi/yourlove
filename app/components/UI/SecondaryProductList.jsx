...
import SecondaryProductListItem from "@/app/components/UI/SecondaryProductListItem";

export default function SecondaryProductList({products = [], slidesPerView640, slidesPerView768, slidesPerView1024, slidesPerView1280, slidesPerView1600}) {
