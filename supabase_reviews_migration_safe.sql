-- Biztonságos migráció - ellenőrzi, hogy létezik-e már
-- Futtatás: Supabase SQL Editor

-- 1. product_reviews tábla létrehozása (ha még nincs)
...
-- 3. products tábla frissítése - statisztikák (ha még nincsenek)
DO $$
BEGIN
...
-- 4. Trigger az updated_at automatikus frissítésére (csak ha még nincs)
...
DROP TRIGGER IF EXISTS trigger_product_review_stats ON product_reviews;
...
DROP POLICY IF EXISTS "Users can update own pending reviews" ON product_reviews;
...
-- KÉSZ! A migráció sikeresen lefutott.
